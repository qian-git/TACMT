function [ new_model ] = model_fusion_position( LCS,model_1,model_2 )
        ...
        if(cnt_model_1 < LCS(3,cnt_LCS))
            ...
            if(cnt_model_2 < LCS(4,cnt_LCS))
                ...
                if(model_1{2}(1,cnt_model_1) > 75)
                    ...
                    if(new_model{2}(1,size_new_model+1) >= 100)
                        new_model{2}(1,size_new_model+1) = 100;
                    end
